...
# 2. Generate Topology
solvated_residues = args.residues + ["W", "NA"]
if args.topology:
    pore_modules.rewrite_top(args.topology, (pore_modules.num_unique_molecules(args.output, solvated_residues)), args.top_output)
